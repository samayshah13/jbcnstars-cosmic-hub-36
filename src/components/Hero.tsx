      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            ...
            {/* Subtitle */}
            <p className="text-base sm:text-lg md:text-xl text-foreground-muted max-w-2xl mx-auto leading-relaxed px-4">
              The 3rd edition of our Mathematics Competition: Scholastic Tournament for Advanced Mathematics and Reasoning Skills.
              <br />
              <span className="font-semibold text-primary">October 11th, 2025, Saturday | 7:30 AM - 3:00 PM | JBCN Parel</span>
              <br />
              Registration fee: INR 1200 per team (includes breakfast & lunch) | Deadline: September 25, 2025
            </p>
