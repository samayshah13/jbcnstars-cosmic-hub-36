        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="relative">
              <img src={currentLogo} alt="JBCNSTARS Official Logo" className="h-14 md:h-16 w-auto group-hover:scale-110 transition-all duration-300 group-hover:opacity-0" />
              <img src={hoverLogo} alt="JBCNSTARS Official Logo Hover" className="h-14 md:h-16 w-auto absolute inset-0 opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:scale-110" />
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            {/* Single Nav Items */}
            {singleNavItems.map(item => <Link key={item.path} to={item.path} className={`nav-link ${isActive(item.path) ? "active" : ""}`}>
                {item.name}
              </Link>)}
          ...
          <div className="lg:hidden flex items-center space-x-2">
            <InstagramEasterEgg className="w-4 h-4" />
            <ThemeToggle />
