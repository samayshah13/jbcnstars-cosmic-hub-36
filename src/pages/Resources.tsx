    ...
    <Layout>
      <div className="py-16 sm:py-20 grid-bg">
        <div className="container mx-auto px-4 sm:px-6">
            ...
            <Card className="max-w-3xl mx-auto bg-primary/5 border-primary/20">
              <CardContent className="p-8 text-center">
                ...
                <Button 
                  ...
                  onClick={() => window.open('https://docs.google.com/forms/d/1xN6dAuu0QCkTfolAy94ajq6KQfqkNGV0tj2pSczP9uU/edit', '_blank')}
                >
          ...
          <div className="mb-20">
            <h2 className="text-4xl font-bold text-center mb-12">
              Study <span className="text-primary">Guides</span>
            </h2>
              ...
              {studyGuides.map((guide, index) => (
                ...
                >
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-2 mb-4 text-xs text-center">
                      <div className="flex justify-between">
                        <span className="text-foreground-muted">Pages:</span>
                        <span className="font-medium">{guide.pages}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-foreground-muted">Level:</span>
                        <span className="font-medium">{guide.level}</span>
                      </div>
                    </div>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              <Card className="text-center bg-card border-card-border">
                <CardContent className="p-6">
                  ...
                  <p className="text-foreground-muted text-sm">Study Guides</p>
                </CardContent>
              </Card>
